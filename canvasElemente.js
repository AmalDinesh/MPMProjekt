...
function clear() { //löschen 
  ...
  c.fillRect(0,0,mycanvas.width,mycanvas.height); // da ist ein fehler
}
function draw() { //animieren
  clear();
  ball11.draw();
  ...
  if(red11 == true){ 
	...
	if(ball11.x > 255 && ball11.y > 308){ //x 255 ,, y 310
		redSwitch11 = true;
		console.log("Route wechseln");
	}
	if(ball11.x > 645 && ball11.y < 270){
			redSwitchnext11 = true;
		}
	...
	if(redSwitch11 == true){
		...
		ball11.x += 4.5;
		console.log("koordinate x = "+ball11.x+" koordinate y = "+ball11.y);
		if(ball11.x > 375 && ball11.y < 169){
			redSwitch11 = false;
		}
		
	}
	if(redSwitchnext11==true){
		ball11.y -= 0.05;
		ball11.x += 7;
		console.log("koordinate x = "+ball11.x+" koordinate y = "+ball11.y);
		if(ball11.x > 600 && ball11.y < 305){
			redSwitchnext11 = false;
		}
	}
  }
